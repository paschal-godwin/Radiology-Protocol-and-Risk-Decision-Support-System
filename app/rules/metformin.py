...
def assess_metformin_risk(case: RadiologyCaseInput) -> dict:
    ...
    if case.metformin_use == MetforminUse.yes and case.egfr < 30:
        return {
            ...
            "message": f"eGFR is {case.egfr} which is below 30 and is considered risky. Patient is on Metformin. Requested CT exam should be reviewed for potential risk of lactic acidosis.",
    ...
    if case.metformin_use == MetforminUse.yes and case.egfr >30:
            return {
                ...
                "message": f"Patient is on Metformin but eGFR is {case.egfr} which is above 30. Risk of lactic acidosis is low but monitor renal function post-scan.",
